...
<div class="card border-0 shadow-sm rounded-3 mb-4">
    <div class="card-body p-4">
        <div class="d-flex align-items-center gap-4">
            <div class="user-avatar" style="width: 80px; height: 80px; font-size: 2rem; background: var(--primary); color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                <c:choose>
                    <c:when test="${not empty student.name}">
...
<div class="card border-0 shadow-sm rounded-3 mb-4">
    <div class="card-body p-4">
        <form action="${pageContext.request.contextPath}/student/edit-profile" method="post">
            ...
            <div class="mt-4">
                <button type="submit" class="btn btn-primary-soft px-4 fw-semibold">
...
<div class="card border-0 shadow-sm rounded-3 mb-4">
    <div class="card-body p-4">
        ...
        <form id="changePwForm" action="${pageContext.request.contextPath}/student/change-password" method="post">
            <div class="row g-3">
                <div class="col-md-4">
            ...
            <div class="mt-4">
                <button type="submit" id="pwSubmitBtn" class="btn btn-primary-soft px-4 fw-semibold">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
                ...
                <p class="text-muted small mb-0">
                    Permanently removes your profile and all associated data. This action cannot be undone.
                </p>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body pt-2">
                <p class="text-muted">This will permanently delete your account and all associated data including bookings. You will be logged out immediately.</p>
            ...
            <div class="modal-footer border-0 pt-0">
                ...
                <form id="deleteAccountForm" action="${pageContext.request.contextPath}/student/delete" method="post">
