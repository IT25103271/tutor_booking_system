...
<html>
<head>
    <title>Add New Subject | Admin</title>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header text-center">
                    <h2 class="fw-bold mb-0">Add New Subject</h2>
                    <p class="text-white-50 mt-2 mb-0">Create a new subject entry in the system</p>
                </div>
                    ...
                    <form action="${pageContext.request.contextPath}/subject/add" method="post">
                        <div class="row g-4">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="subjectName" class="form-control" placeholder="e.g. Advanced Mathematics" required>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-control" rows="4" placeholder="Briefly describe the subject scope..."></textarea>
                            </div>
                            ...
                            <div class="col-12 mt-5">
                                <div class="d-flex gap-3">
                                    <button type="submit" class="btn btn-primary-custom btn-custom flex-grow-1">
                                        <i class="bi bi-cloud-upload-fill me-2"></i>Save Subject
                                    </button>
