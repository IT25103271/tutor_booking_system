...
<ul class="nav nav-pills mb-3">
    <li class="nav-item">
        <a href="${pageContext.request.contextPath}/student/my-bookings" class="nav-link ${empty selectedStatus ? 'active' : ''}">All</a>
    </li>
    <li class="nav-item">
        <a href="${pageContext.request.contextPath}/student/my-bookings?status=PENDING"
           class="nav-link ${selectedStatus == 'PENDING' ? 'active' : ''}">Pending</a>
    </li>
    <li class="nav-item">
        <a href="${pageContext.request.contextPath}/student/my-bookings?status=CONFIRMED"
           class="nav-link ${selectedStatus == 'CONFIRMED' ? 'active' : ''}">Confirmed</a>
    </li>
    <li class="nav-item">
        <a href="${pageContext.request.contextPath}/student/my-bookings?status=COMPLETED"
           class="nav-link ${selectedStatus == 'COMPLETED' ? 'active' : ''}">Completed</a>
    </li>
    <li class="nav-item">
        <a href="${pageContext.request.contextPath}/student/my-bookings?status=CANCELLED"
...
<div class="card border-0 shadow-sm rounded-3">
    <div class="card-header-custom d-flex justify-content-between align-items-center">
        ...
        <span class="badge bg-light text-dark">${bookings.size()} found</span>
    </div>
            ...
            <table class="table table-hover mb-0 align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>${b.subject}</td>
                        <td>${b.sessionDate}</td>
                        <td class="small text-nowrap">${b.timeSlot}</td>
                        ...
                        <td>
                            <div class="d-flex gap-1 flex-nowrap">
                                ...
                                <c:if test="${b.status == 'COMPLETED'}">
                                    <c:if test="${not reviewedBookings[b.id]}">
                                        <a href="${pageContext.request.contextPath}/student/add-review?bookingId=${b.id}"
                                           class="btn btn-sm btn-primary-soft">
                                            <i class="bi bi-star me-1"></i>Review
                                        </a>
                                    </c:if>
                                    <c:if test="${reviewedBookings[b.id]}">
                                        <span class="badge bg-success"><i class="bi bi-check-circle me-1"></i>Reviewed</span>
                                    </c:if>
                                </c:if>
                    ...
                    <c:if test="${empty bookings}">
                        <tr>
                            <td colspan="9" class="text-center text-muted py-5">
                                ...
                                <a href="${pageContext.request.contextPath}/student/view-subjects" class="btn btn-sm btn-primary-soft mt-2">Book a Session</a>
                            </td>
                        </tr>
                    </c:if>
                </tbody>
...
<div class="mt-3 p-3 bg-white rounded-3 shadow-sm">
    ...
    <div class="d-flex gap-3 mt-2 flex-wrap">
        <span class="badge badge-PENDING">PENDING</span> – Awaiting tutor confirmation
