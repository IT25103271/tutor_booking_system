...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-add { background: #0f1f3d; color: #fff; border: none; padding: .55rem 1.2rem; border-radius: 8px; font-weight: 600; cursor: pointer; font-size: .9rem; text-decoration: none; white-space: nowrap; }
        ...
        .modal { background: #fff; border-radius: 12px; padding: 2rem; width: 380px; text-align: center; box-shadow: 0 20px 60px #0000001a; }
        ...
        <table>
            ...
            %>
                <tr><td colspan="7">
                    <div class="empty">
                        <div class="icon">📭</div>
                        <p>No subjects found. Click <strong>+ Add Subject</strong> to get started!</p>
                    </div>
                </td></tr>
            <%
                } else {
            ...
            %>
                <tr>
                    <td><code style="color:#0f1f3d;font-size:.8rem;font-weight:600"><%= s.getSubjectId() %></code></td>
                    ...
                    <td>
                        <div class="actions">
                            <a href="${pageContext.request.contextPath}/subject/edit?id=<%= s.getSubjectId() %>" class="btn-edit">✏️ Edit</a>
                            <button class="btn-delete" onclick="confirmDelete('<%= s.getSubjectId() %>','<%= s.getSubjectName() %>')">🗑️ Delete</button>
                        </div>
                    </td>
                </tr>
            <%  } } %>
...
<script>
    function confirmDelete(id, name) {
        document.getElementById('deleteMsg').innerHTML = 'Delete <strong>' + name + '</strong>? This cannot be undone.';
