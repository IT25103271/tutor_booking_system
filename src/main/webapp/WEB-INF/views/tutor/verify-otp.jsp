...
<head>
  ...
  <title>Verify Email – TutorBooking</title>
...
<div class="container">
  <div class="verify-card">
    ...
    <div class="verify-body">
      ...
      <form action="/tutor/verify-otp" method="post" id="otpForm">
        <div class="mb-4">
      ...
      <form action="/tutor/resend-otp" method="post" class="text-center">
      ...
      <div class="text-center mt-3">
        <a href="/tutor/register" class="text-muted small text-decoration-none">
