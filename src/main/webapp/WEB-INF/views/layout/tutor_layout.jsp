...
<head>
    ...
    <title>${pageTitle != null ? pageTitle : 'Dashboard'} – TutorBooking</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* ── Tables ── */
        .table-hover tbody tr:hover { background-color: rgba(15,52,96,0.04); }
        .table thead th {
        ...
        .section-title {
            ...
            border-left: 4px solid var(--navy2); padding-left: 10px;
...
<div id="sidebar">
    ...
    <!-- Brand -->
    <a href="/tutor/dashboard" class="sb-brand">
    ...
    <ul class="sb-nav">
        ...
        <li>
            <a href="/tutor/logout" data-label="Logout" style="color:rgba(255,100,100,0.85)">
    ...
    <div class="sb-user">
        <div class="sb-avatar">
            <c:choose>
                <c:when test="${not empty sessionScope.tutorName}">${sessionScope.tutorName.charAt(0)}</c:when>
                <c:otherwise>T</c:otherwise>
            </c:choose>
        </div>
        <div class="sb-user-info">
            <div class="sb-user-name">${sessionScope.tutorName}</div>
...
<div id="topbar">
    ...
    <div>
        ...
        <span class="topbar-breadcrumb">/ Tutor</span>
    </div>
    <div class="topbar-actions">
        <span class="text-muted small d-none d-md-inline">${tutor.email}</span>
