...
<div class="layout">
    ...
    <div class="content">
        <div class="hero">
            <div class="hero-small">Share your learning experience</div>
            <h1>Add Tutor Review</h1>
            <span class="badge">STUDENT REVIEW</span>
        </div>
        ...
        <div class="stats">
            ...
            <div class="stat green">
                ...
                <div><strong>Quick</strong><span>FEEDBACK</span></div>
            </div>
            <div class="stat gold">
                <div class="stat-icon">TXT</div>
                <div><strong>Public</strong><span>REVIEW</span></div>
            </div>
        </div>
            ...
            <form action="/reviews/save" method="post">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        <textarea name="comment" rows="7" placeholder="Write your review about the tutor..." required></textarea>
                    </div>
                </div>

                <div class="actions">
                    <button class="btn" type="submit">Submit Review</button>
                    <a class="btn btn-light" href="/reviews/tutor/${tutorId}">Back to Reviews</a>
                </div>
            </form>
        </div>
    </div>
